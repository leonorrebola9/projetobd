...
/* 7) LIMPAR AS TABELAS STAGING
TRUNCATE TABLE Staging_Asteroid;
TRUNCATE TABLE Staging_Orbit;
TRUNCATE TABLE Staging_Software;
TRUNCATE TABLE Staging_Observation;
GO
*/